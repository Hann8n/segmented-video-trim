...
import { showEditor, isValidFile, trim } from 'react-native-video-trim';
...
export default function App() {
  ...
  // Set up event listeners (Old Architecture)
  useEffect(() => {
    console.log('Setting up event listeners (Old Architecture)');
